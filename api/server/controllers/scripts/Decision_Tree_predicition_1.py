...
try:
    ...
    complete_subset_features_1.to_csv(Output_name+'_DT_Predict.csv')

    

    s3_resource.meta.client.upload_file( 
    Filename=Output_name+'_DT_Predict.csv',Bucket='superlearner',Key=Output_name+'_DT_Predict.csv')
   
    key= Output_name+'_DT_Predict.csv'
